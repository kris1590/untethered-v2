...
export default function FullCalendarPage() {
    ...
    const handleAddEvent = async (e: React.FormEvent) => {
        ...
        const evt: CalendarEvent = {
            ...
            facilitator: user?.displayName || user?.email || 'Unknown',
    ...
    const handleDeleteEvent = async (eventId: string) => {
        ...
        try {
            // Remove from local state (you can add Firestore delete later)
    ...
    function renderEventContent(eventInfo: any) {
        ...
        return (
            <div
                className={`
                    ${isBreathwork ? 'bg-blue-500' : 'bg-green-500'} 
        ...
        <div className="bg-gray-50 min-h-screen py-6">
            ...
            {modalOpen && (
                <div className="modal modal-open">
                    <div className="modal-box w-full max-w-xs sm:max-w-md p-6">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <button
                                ...
                                className="btn btn-ghost btn-xs btn-circle text-black focus:outline-none"
                            >
                                ✕
                            </button>
                        </div>
                        <form onSubmit={handleAddEvent} className="space-y-6">
                            <div className="form-control">
                                <span className="label-text font-medium text-black mb-2">Event Type</span>
                                <label className="flex gap-3 items-center cursor-pointer p-2">
                                    <input
                                        type="radio"
                                        name="option"
                                        value="breathwork"
                                    ...
                                    />
                                    <span className="text-black">Breathwork Session</span>
                                </label>
                                <label className="flex gap-3 items-center cursor-pointer mt-3 p-2">
                                    <input
                                        type="radio"
                                        name="option"
                                        value="topic"
                                    ...
                                    />
                                    <span className="text-black">Book Topic</span>
                                </label>
                            </div>
                            {option === 'topic' && (
                                <div className="form-control">
                                    <label>
                                        <span className="label-text font-medium text-black">Topic</span>
                                    </label>
                                    <input
                            ...
                            <div className="modal-action flex flex-col gap-3 sm:flex-row sm:justify-between mt-8">
                                <button
                                    type="button"
                                    className="btn btn-ghost w-full sm:w-auto text-black focus:outline-none"
                                    onClick={() => setModalOpen(false)}
                                    disabled={loading}
                                >
                                    Cancel
                                ...
                                <button
                                    type="submit"
                                    className="btn btn-primary w-full sm:w-auto text-black focus:outline-none"
            ...
            {eventDetailModal && selectedEvent && (
                <div className="modal modal-open">
                    <div className="modal-box w-full max-w-md p-6">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <button
                                ...
                                className="btn btn-ghost btn-sm btn-circle text-black focus:outline-none"
                            >
                                ✕
                            </button>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            {(user?.displayName || user?.email) === selectedEvent.facilitator && (
                    ...
                    <div className="modal-backdrop" onClick={() => setEventDetailModal(false)} />
                </div>
            )
            }
        </div >
